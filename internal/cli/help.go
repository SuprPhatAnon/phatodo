...
var commandSpecs = []commandSpec{
	...
	{path: []string{"task", "create"}, usage: `ptodo task create -t "Title" --prefix <prefix> (or --issue-prefix <prefix>) [-d "desc"] [-p 0-5] [-e <epic-id>] [--kind task|bug|feature|chore|spike] [--root-cause-analysis "why"] [--planned-files-json '["file.go"]'] [--tags "a,b"] [-a <user-id>] [--criteria-json '["criterion 1","criterion 2"]']`},
	...
	{path: []string{"task", "update"}, usage: `ptodo task update <task-id> [-t "Title"] [-d "desc"] [-p 0-5] [-s <status>] [-k task|bug|feature|chore|spike] [--root-cause-analysis "why"] [--changed-files-json '["file.go"]'] [--tags "a,b"] [-e <epic-id>] [--no-epic] [-a <user-id>] [--criteria-json '["criterion 1","criterion 2"]'] [--summary "completion summary"] [--evidence-json '["link-or-note"]']`},
	{path: []string{"task", "delete"}, usage: "ptodo task delete <task-id>"},
	{path: []string{"subtask", "create"}, usage: `ptodo subtask create <task-id> -t "Title" [-d "desc"] [-p 0-5] [--kind task|bug|feature|chore|spike] [--root-cause-analysis "why"] [--planned-files-json '["file.go"]'] [-a <user-id>] [--criteria-json '["criterion 1","criterion 2"]']`},
	{path: []string{"subtask", "list"}, usage: "ptodo subtask list <task-id> [--limit <n>]"},
	{path: []string{"subtask", "update"}, usage: `ptodo subtask update <subtask-id> [-t "Title"] [-d "desc"] [-p 0-5] [-s <status>] [-a <user-id>] [--changed-files-json '["file.go"]'] [--criteria-json '["criterion 1","criterion 2"]'] [--summary "completion summary"] [--evidence-json '["link-or-note"]']`},
